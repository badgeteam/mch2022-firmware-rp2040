...
int nec_tx_init(PIO pio, uint pin_num) {
    ...
    nec_carrier_burst_program_init(pio, carrier_burst_sm, carrier_burst_offset, pin_num,
    ...
    nec_carrier_control_program_init(pio, carrier_control_sm, carrier_control_offset,
