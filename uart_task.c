...
void apply_line_coding(uint8_t itf) {  
    ...
    if ((current_line_coding[itf].data_bits != target_line_coding->data_bits) ||
        (current_line_coding[itf].stop_bits != target_line_coding->stop_bits) ||
        (current_line_coding[itf].parity != target_line_coding->parity)) {
        uart_set_format(uart, calc_data_bits(
            target_line_coding->data_bits),
            calc_stop_bits(target_line_coding->stop_bits),
